  ...
  return (
    <div className="pt-10 pb-16">
      <div className="text-center">
        <h1 className="mx-auto sub-heading">Nos Realisations</h1>
        <h1 className="heading">
          excellents realisations à la fois petites et complexes
        </h1>
      </div>
        ...
        {projects.map(({ id, name, number, image }) => (
          <div key={id} className="relative w-full group">
            <div className="overflow-hidden">
              <Link to="/realisations" className="!opacity-100">
                <img
                  src={image[0]}
                  alt={name}
