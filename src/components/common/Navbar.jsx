...
import LoginModal from "./page-componets/LoginModal";
...
const Navbar = () => {
  ...
  return (
    <div
      className="navbar h-[100px] fixed w-full z-20 top-0 left-0 px-[2%]  md:px-[6%] flex-center-between py-[0.35rem] bg-white/60 border-b backdrop-blur-sm dark:border-dark dark:bg-card-dark/60"
